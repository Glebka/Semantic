package com.semantic.dictionary;

import java.util.Stack;
import com.semantic.dictionary.indexer.*;
...
*/
public class DictionaryIndexer implements IParserEventListener {
    ...
    public DictionaryIndexer(String args[]) {
        if(args.length<3)
        {
